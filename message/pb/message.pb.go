...
type Message_PresenceType int32

const (
	Message_Have     Message_PresenceType = 0
	Message_DontHave Message_PresenceType = 1
	Message_Know     Message_PresenceType = 2
)

var Message_PresenceType_name = map[int32]string{
	0: "Have",
	1: "DontHave",
	2: "Know",
}

var Message_PresenceType_value = map[string]int32{
	"Have":     0,
	"DontHave": 1,
	"Know":     2,
}

func (x Message_PresenceType) String() string {
	return proto.EnumName(Message_PresenceType_name, int32(x))
}

func (Message_PresenceType) EnumDescriptor() ([]byte, []int) {
...
type Message struct {
	...
	// TODO usually one must not change pb numeration but... should we do it?
	BlocksInfo []*Message_BlockInfo `protobuf:"bytes,6,rep,name=blocksInfo,proto3" json:"blocksInfo,omitempty"`
}
...
func (m *Message) GetBlocksInfo() []*Message_BlockInfo {
	if m != nil {
		return m.BlocksInfo
	}
	return nil
...
type Message_BlockPresence struct {
	...
	Type Message_PresenceType `protobuf:"varint,2,opt,name=type,proto3,enum=bitswap.message.pb.Message_PresenceType" json:"type,omitempty"`
}
...
func (m *Message_BlockPresence) GetType() Message_PresenceType {
	if m != nil {
		return m.Type
	}
	return Message_Have
...
// BlockInfo is used to exchange knowledge about blocks
...
func (m *Message_BlockInfo) GetType() Message_PresenceType {
	if m != nil {
		return m.Type
	}
	return Message_Have
...
func (m *Message_BlockInfo) GetSources() []string {
	if m != nil {
		return m.Sources
	}
	return nil
...
func init() {
	proto.RegisterEnum("bitswap.message.pb.Message_PresenceType", Message_PresenceType_name, Message_PresenceType_value)
...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BlocksInfo) > 0 {
		for iNdEx := len(m.BlocksInfo) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.BlocksInfo[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Message_BlockInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Sources) > 0 {
		for iNdEx := len(m.Sources) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintMessage(dAtA, i, uint64(len(m.Sources[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlocksInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BlocksInfo = append(m.BlocksInfo, &Message_BlockInfo{})
			if err := m.BlocksInfo[len(m.BlocksInfo)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= Message_PresenceType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
